function rvshpcmskd
{
  param(
    ...
    [alias("GenerateP")][switch]$g=$False,
  ...
  ########## RETURN GENERATED ##########
  if($ge){Write-Verbose "Returning Encoded PD..." ; return [Convert]::ToBase64String([System.Text.Encoding]::Unicode.GetBytes($InvokeString))}
  elseif($g){Write-Verbose "Returning PD..." ; return $InvokeString}
  ########## RETURN GENERATED ##########
